...
function get_user_avatar($user_id, $username) {
    ...
    if ($path && file_exists($path)) {
        ...
        $svg = '<svg width="100" height="100" xmlns="http://www.w3.org/2000/svg"><rect width="100" height="100" fill="#'.substr(safe_hash($username), 0, 6).'"></rect><text x="50" y="50" font-family="Arial" font-size="50" fill="white" text-anchor="middle" dy=".3em">'.$initial.'</text></svg>';
